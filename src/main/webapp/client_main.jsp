...
<%--  <link href="Assets/img/apple-touch-icon.png" rel="apple-touch-icon">--%>
  ...
  <!-- Main CSS File -->
  <link href="CSS/client_main.css" rel="stylesheet">
  ...
  <div class="topbar d-flex align-items-center">
    <div class="container d-flex justify-content-end justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-phone d-flex align-items-center d-none d-lg-block"><span>+94 11 55488 55</span></i>
...
<%--        <img src="Assets/logo_abc.png" alt="">--%>
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div id="carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item active">
        <img src="Assets/img/carousel/background_img_1.jpg" alt="">
      ...
      <div class="carousel-item">
        <img src="Assets/img/carousel/background_img_2.jpg" alt="">
        <div class="carousel-container">
      ...
      <div class="carousel-item">
        <img src="Assets/img/carousel/background_img_3.jpg" alt="">
        <div class="carousel-container">
